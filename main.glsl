...
const float rA=0.5; // Minimum ray marching distance from origin
const float rB=1000.0; // Maximum
...
float object(vec3 p)
{
    float height = turbulence(p.xz, 0.6, 0.35, 0.5, 3);
    return height-0.5-p.y;
}
